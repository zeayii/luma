...
internal sealed class LumaNodeState
{
    ...
    /// 增加排队请求数量。
    /// </summary>
    public void IncrementQueued() => Interlocked.Increment(ref _queuedRequestCount);

    /// <summary>
    /// 减少排队请求数量。
    /// </summary>
    public void DecrementQueued() => Interlocked.Decrement(ref _queuedRequestCount);

    /// <summary>
    /// 增加活跃请求数量。
    /// </summary>
    public void IncrementActive() => Interlocked.Increment(ref _activeRequestCount);

    /// <summary>
    /// 减少活跃请求数量。
    /// </summary>
    public void DecrementActive() => Interlocked.Decrement(ref _activeRequestCount);
